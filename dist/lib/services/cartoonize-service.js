...
function cleanStoryPrompt(prompt) {
    return prompt
        .trim()
...
export class CartoonizeService {
    ...
    async processCartoonize(options) {
        ...
        const stylePrompt = stylePrompts[style] || stylePrompts['semi-realistic'];
...
//# sourceMappingURL=cartoonize-service.js.map