...
`;
        try {
            ...
            const updatedPages = parsed.pages.map((page) => ({
                ...page,
            ...
            console.log(`📊 Generated ${updatedPages.length} pages with ${updatedPages.reduce((total, page) => total + page.scenes.length, 0)} scenes`);
            return {
                pages: updatedPages,
                audience,
                characterImage,
